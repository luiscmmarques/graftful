...
- [ ] No personal data is committed — the pre-commit hook scans staged content (installed by `npm install`) and `src/lib/personal-data.test.ts` scans the tree in CI
