...
export const fr: Messages = {
	...
	about: {
		...
		donateBefore: 'Si Graftful vous est utile, un',
		donateLink: 'don',
		donateAfter: ' aide à le maintenir en ligne. ❤️',
		...
		trademarks:
			'PayPal, GitHub, Cloudflare et Kiro sont des marques de leurs propriétaires respectifs. Les nommer ici indique seulement ce sur quoi Graftful repose et vers quoi il renvoie ; aucun d’eux n’est affilié à Graftful ni ne le cautionne.',
	...
	roadmap: {
		...
		languagesBody:
			'L’anglais, le français, l’allemand, le portugais et l’italien couvrent toute l’application, la commande à la pharmacie et le fichier de calendrier. Les traductions sont bienvenues et vont plus loin que l’argent.',
	...
	support: {
		...
		free2:
			'Ce qui lui manque vraiment, c’est que les gens sachent qu’il existe. Si vous l’avez trouvé utile, en parler à une seule personne vaut plus qu’un don.',
		...
		translationState:
			'Toute l’application est disponible en anglais, français, allemand, portugais et italien, y compris la commande à la pharmacie et le fichier de calendrier.',
		translationBefore:
		...
		moneyTitle: 'Faire un don ❤️',
		moneyNote:
			'Si Graftful vous est utile, un don aide à le maintenir en ligne. Je l’ai créé parce que je vis moi aussi avec ce handicap invisible. Vraiment facultatif — gérer une transplantation coûte déjà assez cher.'
	},
	notFound: {
