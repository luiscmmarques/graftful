...
export const pt: Messages = {
	...
	about: {
		...
		donateBefore: 'Se o Graftful lhe é útil, um',
		donateLink: 'donativo',
		donateAfter: ' ajuda a mantê-lo online. ❤️',
		...
		trademarks:
			'PayPal, GitHub, Cloudflare e Kiro são marcas dos respetivos proprietários. Nomeá-los aqui indica apenas aquilo em que o Graftful assenta e para onde liga; nenhum deles está associado ao Graftful nem o apoia.',
	...
	roadmap: {
		...
		languagesBody:
			'Inglês, francês, alemão, português e italiano cobrem toda a aplicação, a encomenda para a farmácia e o ficheiro de calendário. As traduções são bem-vindas e vão mais longe do que dinheiro.',
	...
	support: {
		...
		free2:
			'O que realmente lhe falta é que as pessoas saibam que existe. Se o achou útil, falar dele a uma pessoa vale mais do que um donativo.',
		...
		translationState:
			'Toda a aplicação está disponível em inglês, francês, alemão, português e italiano, incluindo a encomenda para a farmácia e o ficheiro de calendário.',
		translationBefore:
		...
		moneyTitle: 'Fazer um donativo ❤️',
		moneyNote:
			'Se o Graftful lhe é útil, um donativo ajuda a mantê-lo online. Criei-o porque também vivo com esta deficiência invisível. Genuinamente opcional — gerir um transplante já é caro o suficiente.'
	},
	notFound: {
