...
export const de: Messages = {
	...
	about: {
		...
		donateBefore: 'Wenn Graftful Ihnen nützt, hilft eine',
		donateLink: 'Spende',
		donateAfter: ', es online zu halten. ❤️',
		...
		trademarks:
			'PayPal, GitHub, Cloudflare und Kiro sind Marken ihrer jeweiligen Inhaber. Ihre Nennung sagt nur, worauf Graftful aufbaut und wohin es verlinkt; keiner von ihnen ist mit Graftful verbunden oder unterstützt es.',
	...
	roadmap: {
		...
		languagesBody:
			'Englisch, Französisch, Deutsch, Portugiesisch und Italienisch decken die ganze App ab, dazu die Apothekenbestellung und die Kalenderdatei. Übersetzungen sind willkommen und bringen mehr als Geld.',
	...
	support: {
		...
		free2:
			'Was wirklich fehlt, ist, dass Menschen von seiner Existenz wissen. Wenn Sie es nützlich gefunden haben, ist es einer anderen Person davon zu erzählen mehr wert als eine Spende.',
		...
		translationState:
			'Die ganze App ist auf Englisch, Französisch, Deutsch, Portugiesisch und Italienisch verfügbar, einschließlich der Apothekenbestellung und der Kalenderdatei.',
		translationBefore:
		...
		moneyTitle: 'Spenden ❤️',
		moneyNote:
			'Wenn Graftful Ihnen nützt, hilft eine Spende, es online zu halten. Ich habe es gebaut, weil ich selbst mit dieser unsichtbaren Behinderung lebe. Wirklich freiwillig — eine Transplantation zu bewältigen ist teuer genug.'
	},
	notFound: {
