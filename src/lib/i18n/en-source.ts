...
export const en: Messages = {
	...
	about: {
		...
		donateBefore: 'If Graftful is useful to you, a',
		donateLink: 'donation',
		donateAfter: ' helps keep it online. ❤️',
		...
		trademarks:
			'PayPal, GitHub, Cloudflare and Kiro are trademarks of their respective owners. Naming them here only says what Graftful runs on and links to; none of them is affiliated with Graftful or endorses it.',
	...
	roadmap: {
		...
		languagesBody:
			'English, French, German, Portuguese and Italian cover the whole app, the pharmacy order and the calendar file. Translations are welcome and go further than money.',
	...
	support: {
		...
		free2:
			'What it genuinely lacks is people knowing it exists. If you have found it useful, telling one other person is worth more than a donation.',
		...
		translationState:
			'The whole app is available in English, French, German, Portuguese and Italian, including the pharmacy order and the calendar file.',
		translationBefore:
		...
		moneyTitle: 'Donate ❤️',
		moneyNote:
			'If Graftful is useful to you, a donation helps keep it online. I built it because I live with this invisible disability too. Genuinely optional — managing a transplant is expensive enough.'
	},
	notFound: {
