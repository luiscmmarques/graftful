<script lang="ts">
	/*
	 * Formerly a tips page. Reframed deliberately.
	 *
	 * The audience is people managing a lifelong condition, often alongside reduced income
	 * and real medical costs. Asking them for money — next to a medication reminder — is
	 * distasteful, and what the project lacks even more than money is people who know it
	 * exists. So the donate card stays quietly at the bottom, and the page is about
	...
	/*
	 * The link itself lives in src/lib/DonateLink.svelte and the URL in $lib/contact —
	 * one source of truth shared with the About page.
	 */
	const moneyConfigured = Boolean(donateUrl);
</script>
